...
class _ServiceGridCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final emoji = service.emoji ?? _emojiForServiceName(service.name);
...
// ─── Emoji fallback by service name (when DB emoji is null) ─────────────────
...
String _emojiForServiceName(String name) {
  ...
  if (n.contains('curtain') || n.contains('drape')) return '\u{1FA9F}'; // 🪟
